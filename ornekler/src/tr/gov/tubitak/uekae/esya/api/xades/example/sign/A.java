...
/**
 * A type signature signing sample
 */
public class A extends XadesSampleBase {

    public static final String SIGNATURE_FILENAME = "a.xml";

    /**
     * Creates detached A type signature
     *
     * @throws Exception
     */
    @Test
